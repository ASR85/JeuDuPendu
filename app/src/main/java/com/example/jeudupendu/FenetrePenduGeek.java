...
import com.example.jeudupendu.R;
...
public class FenetrePenduGeek extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fenetre_pendu_geek);
    ...
    public List<String> donnerlisteMots(){
        ...
        try {
            BufferedReader buffer = new BufferedReader(new InputStreamReader(getAssets().open("geek.txt")));
            String ligne;
