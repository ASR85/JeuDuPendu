...
public class FenetrePenduSeries extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fenetre_pendu);
    ...
    public List<String> donnerlisteMots(){
        ...
        try {
            BufferedReader buffer = new BufferedReader(new InputStreamReader(getAssets().open("series.txt")));
            String ligne;
